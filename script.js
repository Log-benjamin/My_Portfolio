...
const projectDetails = [
  {
    ...
    image: 'assets/Todo_List_App_img1.PNG',
    technologies: ['HTML/CSS', 'ES6', 'Webpack'],
    articleClass: 'pr-d1',
    liveLink: 'https://log-benjamin.github.io/TodoList-App/dist/',
    sourceLink: 'https://github.com/Log-benjamin/TodoList-App#live-demo',
  },
  {
    idd: 1,
    seeProjectBtn: 1,
